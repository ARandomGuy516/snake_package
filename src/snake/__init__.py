...
def main():
    ...
    argparse.ArgumentParser(
        prog="snake",
        description=(
            "A simple terminal Snake game toolkit.\n\n"
            "Create a screen:\n"
            "  screen = Snake.Screen()\n"
            "You can customize its background, width, and height.\n\n"
            "Create your snake:\n"
            "  snake = Snake.snake()\n"
            "You can customize its look, name, tail size, saved positions, and direction.\n\n"
            "Create an apple:\n"
            "  apple = Snake.Apple()\n"
            "Apples spawn randomly; eating one increases your score and snake length.\n\n"
            "if you're feeling fancy:\n"
            "Optional obstacle:\n"
            "  boulder = Snake.Boulder()\n"
            "Boulders fall down the screen, and you can customize their shape, fall speed, spawn range, and count.\n\n"
            "Controls:\n"
            "  w / a / s / d  move up / left / down / right\n"
            "  e              start easy mode (walls wrap)\n"
            "  n              start normal mode (walls kill)\n"
            "  r              restart after losing\n"
            "  q              quit\n"

            "screen functions:\n"
            "screen.update():\n"
            "  updates the screen, returns the new screen\n"
            "  how to use: screen.update()\n"
            "screen.check_for_inputs():\n"
            "  checks for inputs, returns the key pressed\n"
            "  how to use: k = screen.check_for_inputs()\n"
            "screen.inputed():\n"
            "  checks if the key pressed is valid, returns True if it is, False if it is not\n"
            "  how to use: if screen.inputed(k): ...\n"
            "screen.start_menu():\n"
            "  starts the menu, returns the key pressed\n"
            "  how to use: screen.start_menu()\n"
            "screen.looser_menu():\n"
            "  starts the loser menu, returns the key pressed\n"
            "  how to use: screen.looser_menu()\n"
            "screen.reset():\n"
            "  resets the screen, returns the new screen\n"
            "  how to use: screen.reset()\n"

            "snake functions:\n"
            "snake.forward():\n"
            "  makes the snake move forward one step in the direction it is facing\n"
            "  how to use: snake.forward()\n"
            "snake.collition():\n"
            "  checks if the snake has collided with anything, returns a list of the objects it has collided with\n"
            "  how to use: collisions = snake.collition()\n"
            "snake.grow():\n"
            "  makes the snake grow one step, returns the new size of the snake\n"
            "  how to use: snake.grow()\n"
            "snake.save_pos():\n"
            "  saves the position of the snake, returns the new position of the snake\n"
            "  how to use: snake.save_pos()\n"
            "snake.update_der():\n"
            "  updates the direction of the snake based on the key pressed\n"
            "  how to use: snake.update_der(k)\n"

            "boulder functions:\n"
            "boulder.go_down():\n"
            "  makes the boulder go down one step, returns the new position of the boulder\n"
            "  how to use: boulder.go_down()\n"

            "apple functions:\n"
            "apple.rtp():\n"
            "  makes the apple spawn in a random position, returns the new position of the apple\n"
            "  how to use: apple.rtp()\n"
        ),
