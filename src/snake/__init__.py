...
def main():
    ...
    argparse.ArgumentParser(
        ...
        description=(
            ...
            "  screen.start_menu()          choose difficulty\n"
            "  screen.looser_menu()         restart or quit\n"
            "  screen.reset()               reset game state\n\n"
            "Snake:\n"
            "  snake.forward()              move one step in the direction it is facing\n"
            "  collisions = snake.collition() check collisions\n"
            "  snake.grow()                 grow by one step\n"
            "  snake.save_pos()             save tail position\n"
            "  snake.update_der(k)          update direction based on the key pressed\n\n"
            "Boulder:\n"
